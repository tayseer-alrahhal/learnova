            ...
            <div className="container mx-auto px-4 md:px-6">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        >
                            Discover a world of knowledge with our interactive courses, expert instructors, and a supportive
                            community designed to help you achieve your learning goals.
                        </motion.p>
                        ...
                        >
                            ...
                            <Link
                                href="/about"
                                className="inline-flex items-center justify-center px-6 py-3 border border-[var(--color-primary)] text-[var(--color-primary)] rounded-lg font-medium hover:bg-[var(--color-primary)]/5 transition-all duration-200"
                            >
